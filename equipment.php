...
<head>
    <meta charset="UTF-8">
    <meta name="viewport">
    <title>Equipment - Computer Equipment & Games</title>
...
<div class="container">
        <h2 style="margin-top: 100px;">Computer Equipment & Video Game Consoles</h2>
    ...
    $sql = "SELECT name, image_url, price FROM equipment";
